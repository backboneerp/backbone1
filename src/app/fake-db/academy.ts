export class AcademyFakeDb
{
    public static courses = [
        {
            ...
            'title'   : 'Society Configuration Management',
            'slug'    : 'basics-of-angular',
            'category': 'Society Management ERP',
            'length'  : 30,
            'updated' : 'Jun 28, 2017'
        },
        {
        ...
        },
        {
            ...
            'category': 'Educational Institution ERP',
            'length'  : 30,
            'updated' : 'Jun 28, 2017'
        },*/
    ...
    public static categories = [
        {
            'id'   : 0,
            'value': 'Society Management ERP',
            'label': 'Society Management ERP'
        },
        {
            'id'   : 1,
            'value': 'Retail ERP',
        ...
        {
            'id'   : 2,
            'value': 'Manufacturing ERP',
            'label': 'Manufacturing ERP'
        },
        {
            'id'   : 3,
            'value': 'Healthcare ERP',
            'label': 'Healthcare ERP'
        },
        {
            'id'   : 4,
            'value': 'Educational Institution ERP',
            'label': 'Educational Institution ERP'
        }
    ];
